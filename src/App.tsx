...
function App() {
  ...
  const actionsEnumOptions = Object.keys(ActionsEnum).filter((key) =>
    isNaN(Number(key))
  );
  const conditionsEnumOptions = Object.keys(ConditionsEnum).filter((key) =>
    isNaN(Number(key))
  );
  const operators = [" ", ">", "<", "!", "=="];
  ...
  const handleConditionChange =
    (actionIndex: number, conditionIndex: number, prop: string) =>
    (event: any) => {
      const updatedActions = [...actions];
  ...
  const handleConditionTypeChange =
    (actionIndex: number, conditionIndex: number) => (event: any) => {
      if (
        actionIndex != null &&
        actionIndex >= 0 &&
  ...
  return (
    <div className="App">
              ...
              >
                ...
                <TableCell align="right">
                  <TextField
                    ...
                    sx={{ width: "75px" }}
                    id="outlined-basic"
                    value={action.hasCastBar ? "Yes" : "No"}
                    variant="outlined"
        ...
        >
          ...
          <DialogContent>
            ...
            {selectedActionIndex !== null &&
              actions[selectedActionIndex]?.conditions?.map(
                (condition, index) => (
                        ...
                        <TableRow key={index}>
                          <TableCell sx={{ width: 100 }}>
                            ...
                            <Button
                              ...
                              color="error"
                              onClick={() =>
                                deleteCondition(selectedActionIndex, index)
                              }
                            >
                              Delete
                            </Button>
                          ...
                          <TableCell>
                            <Select
                              ...
                              onChange={handleConditionTypeChange(
                                selectedActionIndex,
                                index
                              )} // Adjusted to pass both action and condition indexes
                            >
                              {conditionsEnumOptions.map(
                                (conditionValue, enumIndex) => (
                                  <MenuItem
                                    key={enumIndex}
      ...
      <Box>
        light leather;medium leather;thick leather;heavy hide;thick hide;wool
        cloth;mageweave cloth;iridescent pearl;mystery meat;bear meat;big bear
        meat;elemental air;elermental fire;large knapsack;linen cloth;lion
        meat;small green bag;small red bag;jade;felcloth;turtle scale;small
        flame sac;runecloth;rugged leather;grave moss;giant
        egg;tigerseye;shadowgem;lesser moonstone;moss
        agate;citrine;aquamarina;star ruby;healing;recipe;chunk of boar
        meat;sharp claw;bag;sack;pack;silk;large fang;elemental earth;red wolf
        meat;wicked claw;scorpid scale;heavy leather;tender wolf meat;vibrant
        plume;tender wolf meat;large venom sac;rugged leather;rugged
        hide;essence of fire;living essence;golden pearl;zesty clam meat;black
        pearl;felcloth;essence of water;spider's silk;shadow silk;stringy wolf
        meat;bear meat;runecloth;solid stone;elemental earth;turtle scale;blue
        dragonscale;black dragonscale;black whelp scale;essence
      </Box>
      <input
        type="file"
        id="fileInput"
